...
public interface Frame {
     ...
     * 
     * @param escape
     *            A boolean variable stating if the function parameter escapes
     *            outside the function. Typically, a non-escaping parameter may
     ...
     * 
     * @param index
     *            The index (starting from zero) of the parameter.
     */
     ...
     * 
     * @param func
     *            The name of the external function as seen from within
     *            MiniJava.
     * @param args
     ...
     * 
     * @param body
     *            The function body, including code to move the return value
     ...
     * 
     * @param inst
     *            The list of instructions to which the sink instruction should
     *            be appended.
